...
TOKEN = '7140505401:AAEaJL-Zbe2wwAQP9MRiF_EyUUNOM85Qa74'
...
FORWARD_CHANNEL_ID = -1002219458214
CHANNEL_ID = -1002219458214
error_channel_id = -1002219458214
...
def send_welcome(message):
    ...
    # Create buttons
    btn1 = KeyboardButton("/Owner 🧡")
    btn2 = KeyboardButton("/Price List 💥")
    btn3 = KeyboardButton("/UPI-ID✔️")
    btn4 = KeyboardButton("/My Account🏦")
    btn5 = KeyboardButton("/Help❓")
    btn6 = KeyboardButton("/Attack✔️")
...
def handle_message(message):
    if message.text == "/Owner 🧡":
        bot.reply_to(message, "*@Official_ShouT*", parse_mode='Markdown')
    elif message.text == "/Price List":
        bot.reply_to(message, "*Dm to Buy", parse_mode='Markdown')
        attack_command(message)
    elif message.text == "/UPI-ID✔️":
        bot.send_message(message.chat.id, "finishermods@ybl*", parse_mode='Markdown')
